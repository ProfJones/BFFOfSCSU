package com.example.harrison.bffofscsu.com.components.freeresoureactivity;
...
import com.example.harrison.bffofscsu.R;
...
public class MyExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        ImageView childIcon = (ImageView)convertView.findViewById(R.id.chile_icon);
        childIcon.setImageResource(R.drawable.search);//Here payattention
        final TextView childText = (TextView) convertView.findViewById(R.id.child_text);
        childText.setText(childRow.getText().trim());

        final View findConvertView = convertView;
        childText.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Toast.makeText(findConvertView.getContext(),childText.getText()
    ...
    public void filterData(String query){
        ...
        if(query.isEmpty()){
            ...
            for(ParentRow parentRow : originalList){
                ArrayList<ChildRow> childRows = parentRow.getChildList();
